...
public class CommandCancel {
	...
	private static int cancel(CommandSourceStack sender) {
		...
		MutableComponent cancelFalse= Component.translatable(ServerStopEventHandler.getTranslations("serverstop.commands.cancel.display1"));
		MutableComponent cancelTrue = Component.translatable(ServerStopEventHandler.getTranslations("serverstop.commands.cancel.display2"));
